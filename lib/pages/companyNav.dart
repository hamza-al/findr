...
class CompanyNav extends StatefulWidget {
  const CompanyNav({Key? key}) : super(key: key);

  @override
  _CompanyNavState createState() => _CompanyNavState();
}

class _CompanyNavState extends State<CompanyNav> {
  int _index = 1;
